(function($){
	...
	$(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/cryptlight_elementor_video_popup.default', function(){
	       
	        $('.ova-video-popup').each( function() {
	        	var that = $(this);

	        	var video_container = that.find('.ova-video-popup-container');
